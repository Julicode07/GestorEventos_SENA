...
const SubEvents = memo(({ subEvents }) => {
  const validSubEvents = subEvents.filter(
    (subEvent) => subEvent.id_sub_event !== null
  );
  ...
  return (
    <div className="flex flex-col border-1 rounded-lg p-3 mt-3 space-y-4">
      ...
      {validSubEvents.length === 0 ? (
        <p className="text-gray-800 text-xl font-bold text-center py-6">
        ...
        validSubEvents.map((subEvent) => (
          <div
            ...
            className="flex flex-col rounded-lg p-3 space-y-2  bg-gray-100"
          >
            <h2 className="font-bold text-xl">
              Subevento: {subEvent.sub_event_name}
            </h2>
            <p>
            ...
            <p>
              ...
              {dayjs(subEvent.start_date).format("DD/MM/YYYY HH:mm:ss")}
            </p>
            <p>
              <span className="font-bold">Fecha Fin: </span>
              {dayjs(subEvent.end_date).format("DD/MM/YYYY HH:mm:ss")}
            </p>
            <p>
            ...
            <div className="flex items-center space-x-3">
              ...
              <p
                className={`rounded-full px-2 py-1 text-xs w-fit ${
