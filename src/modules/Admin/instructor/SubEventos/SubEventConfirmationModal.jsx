              ...
              <form action="" className="p-3" onSubmit={handleSubmit}>
                <div className="flex flex-col m-4">
                  ...
                  >
                    ...
                    <p
                      className={`text-bold text-small text-center rounded-lg p-1 ${
                        subEventStatus[0]?.subeventConfirmation === "Confirmado"
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <Button
                      type="submit"
                      className="bg-orange-300 text-orange-800 text-base rounded-lg w-full p-3 flex justify-center items-center"
